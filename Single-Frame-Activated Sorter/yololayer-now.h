...
namespace Yolo
{
    static constexpr int CHECK_COUNT = 3; //default=3
    static constexpr float IGNORE_THRESH = 0.1f;//default=0.1f
    struct YoloKernel
    {
        int width;
        int height;
        float anchors[CHECK_COUNT * 2]; //default=2
    };
    static constexpr int MAX_OUTPUT_BBOX_COUNT = 1000;
    static constexpr int CLASS_NUM = 2;  //num_class need to change
